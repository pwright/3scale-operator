...
func (r *ReconcileProduct) reconcile(productResource *capabilitiesv1beta1.Product) (reconcile.Result, error) {
	...
	providerAccount, err := helper.LookupProviderAccount(r.Client(), productResource.Namespace, productResource.Spec.ProviderAccountRef, logger)
	if err != nil {
...
func (r *ReconcileProduct) checkExternalRefs(resource *capabilitiesv1beta1.Product, providerAccount *helper.ProviderAccount) error {
	...
	backendList, err := controllerhelper.BackendList(resource.Namespace, r.Client(), providerAccount, r.Logger())
	if err != nil {
